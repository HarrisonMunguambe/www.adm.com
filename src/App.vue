...
<template>
  <div class="page-wrapper">
                    ...
                    <div class="container-fluid">
                        <div class="header-menu-content">
                            <nav class="navbar navbar-expand-lg p-0">
                                <router-link class="site-logo site-title" to="/index"><img src="@/assets/images/logo.png"
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <div class="header-right">
                                        ...
                                        <div class="header-action-area">
                                            <router-link to="/service-details" class="action-btn two"><i
                                                    class="icon-btn-icon"></i></router-link>
                                            <div class="header-action">
                                                <router-link to="/service-details" class="btn--base"><i
                                                        class="icon-btn-icon"></i> Book Now</router-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xxl-5 col-xl-6 col-lg-12 mb-30">
                        <div class="banner-content" data-aos="fade-right" data-aos-duration="1800">
                            ...
                            <div class="banner-btn">
                                <router-link to="/package-details" class="btn--base"><i
                                        class="fas fa-chevron-right mr-2"></i> Make Your Trip</router-link>
                                <router-link to="/contact" class="btn--base active">Request Quote <i
                                        class="icon-Group-2361 ml-2"></i></router-link>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="overview-item">
                                    <div class="overview-thumb">
                                        ...
                                        <div class="overview-thumb-content">
                                            <h3 class="title"><router-link to="/service-details">Private Jet Charter</router-link>
                                            </h3>
                                            <p>Trade crowded airports and wasted time for the ease, comfort, and
                                                convenience of travel by private jet.</p>
                                            <div class="overview-btn">
                                                <router-link to="/service-details" class="custom-btn"><i
                                                        class="icon-btn-icon-v2"></i> Book Now</router-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade show active" id="business-jet" role="tabpanel"
                                ...
                                <div class="overview-item">
                                    <div class="overview-thumb">
                                        <img src="@/assets/images/overview/overview-1.png" alt="overview">
                                        <div class="overview-thumb-content">
                                            <h3 class="title"><router-link to="/service-details">Business Jet Charter</router-link>
                                            </h3>
                                            <p>Trade crowded airports and wasted time for the ease, comfort, and
                                                convenience of travel by private jet.</p>
                                            <div class="overview-btn">
                            ...
                            <div class="tab-pane fade" id="private-helicopter" role="tabpanel"
                                ...
                                <div class="overview-item">
                                    <div class="overview-thumb">
                                        <img src="@/assets/images/overview/overview-1.png" alt="overview">
                                        <div class="overview-thumb-content">
                                            <h3 class="title"><router-link to="/service-details">Private Helicopter</router-link></h3>
                                            <p>Trade crowded airports and wasted time for the ease, comfort, and
                                                convenience of travel by private jet.</p>
                                            <div class="overview-btn">
                                                <router-link to="/service-details" class="custom-btn"><i
                            ...
                            <div class="tab-pane fade" id="air-ambulance" role="tabpanel"
                                ...
                                <div class="overview-item">
                                    <div class="overview-thumb">
                                        <img src="@/assets/images/overview/overview-1.png" alt="overview">
                                        <div class="overview-thumb-content">
                                            <h3 class="title"><router-link to="/service-details">Air Ambulance</router-link></h3>
                                            <p>Trade crowded airports and wasted time for the ease, comfort, and
                                                convenience of travel by private jet.</p>
                                            <div class="overview-btn">
                                                <router-link to="/service-details" class="custom-btn"><i
    ...
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        ...
        Start Statistics
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <section class="statistics-section bg-overlay-black ptb-120 bg_img" style="background-image: url('/src/assets/images/bg/bg-2.png')">
            <div class="container">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        ...
                                        <div class="charter-content">
                                            <h3 class="title"><router-link to="/deals-details">Private Jet Charter</router-link></h3>
                                            ...
                                            <div class="charter-btn">
                                                <router-link to="/service-details"><i class="icon-btn-icon-v2"></i> Book
                                                    Now</router-link>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        ...
                                        <div class="charter-content">
                                            <h3 class="title"><router-link to="/deals-details">Business Jet Charter</router-link></h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        ...
                                        <div class="charter-content">
                                            <h3 class="title"><router-link to="/deals-details">Private Helicopter</router-link></h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="charter-item">
                                        ...
                                        <div class="charter-content">
                                            <h3 class="title"><router-link to="/deals-details">Air Ambulance</router-link></h3>
                                            <span class="sub-title">Beech BE300 Super King</span>
                                            <div class="charter-meta">
                                                <span class="seat">8 - 14 Seats</span>
                                                <span class="price">Price: $9,000/ hr</span>
    ...
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <section class="book-form-section ptb-120">
            <div class="container">
                <div class="book-form-area bg-overlay-black bg_img" style="background-image: url('/src/assets/images/bg/bg-3.png')">
                    <div class="row justify-content-center">
                        <div class="col-xl-12 text-center">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="package-item">
                                        ...
                                        <div class="package-content">
                                            <div class="package-content-header">
                                                <h3 class="title"><router-link to="/package-details">Island of the Goods</router-link>
                                                </h3>
                                            </div>
                                            <div class="package-content-body">
                                                ...
                                                <div class="package-content-footer">
                                                    <div class="package-btn">
                                                        <router-link to="/service-details" class="custom-btn"><i
                                                                class="icon-btn-icon-v2 mr-2"></i> Book Now</router-link>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="package-item">
                                        ...
                                        <div class="package-content">
                                            <div class="package-content-header">
                                                <h3 class="title"><router-link to="/package-details">City of the Goods</router-link>
                                                </h3>
                                            </div>
                                            <div class="package-content-body">
                                                <ul class="package-list">
                                ...
                                <div class="swiper-slide">
                                    <div class="package-item">
                                        ...
                                        <div class="package-content">
                                            <div class="package-content-header">
                                                <h3 class="title"><router-link to="/package-details">Desert of the Goods</router-link>
                                                </h3>
                                            </div>
                                            <div class="package-content-body">
                                                <ul class="package-list">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="title"><router-link to="/blog-details">Charter flight of the Death Penalty in
                                        America</router-link></h3>
                                <p>With a vast array of popular private planes to choose from, travelling by private jet
                                    charter is the most efficient</p>
                                <div class="blog-btn">
                                    <router-link to="/blog-details">Read More <i class="icon-Group-2361 ml-2"></i></router-link>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="title"><router-link to="/blog-details">Our technology consistently deliver</router-link>
                                </h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="title"><router-link to="/blog-details">Search the world with ease and
                                        transparency</router-link></h3>
